...
import pe.edu.tecsup.learnai.paq_exception.DuplicatedUserInfoException;
import pe.edu.tecsup.learnai.paq_exception.InvalidCodeException;
import pe.edu.tecsup.learnai.paq_rest.paq_request.*;
import pe.edu.tecsup.learnai.paq_security.paq_JWT.JwtUtils;
import pe.edu.tecsup.learnai.paq_services.paq_email.EmailService;
...
public class AuthController{
    ...
    public ResponseEntity<AuthResponse> login(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        if (userOptional.isPresent()) {
            ...
            String token = jwtUtils.generateToken(user.getUsername(), user.getVerificationCode().toString());
